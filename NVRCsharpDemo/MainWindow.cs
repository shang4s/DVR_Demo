...
{    
    public partial class MainWindow : Form
    {
        ...
        private void btnPlaybackTime_Click(object sender, EventArgs e)
        {
            ...
            struVodPara.struBeginTime.dwYear = dateTimeStart.Value.Year;
            struVodPara.struBeginTime.dwMonth = dateTimeStart.Value.Month;
            struVodPara.struBeginTime.dwDay = dateTimeStart.Value.Day;
            struVodPara.struBeginTime.dwHour = dateTimeStart.Value.Hour;
            struVodPara.struBeginTime.dwMinute = dateTimeStart.Value.Minute;
            struVodPara.struBeginTime.dwSecond = dateTimeStart.Value.Second;

            //设置回放的结束时间 Set the stopping time to search video files
            struVodPara.struEndTime.dwYear = dateTimeEnd.Value.Year;
            struVodPara.struEndTime.dwMonth = dateTimeEnd.Value.Month;
            struVodPara.struEndTime.dwDay = dateTimeEnd.Value.Day;
            struVodPara.struEndTime.dwHour = dateTimeEnd.Value.Hour;
            struVodPara.struEndTime.dwMinute = dateTimeEnd.Value.Minute;
            struVodPara.struEndTime.dwSecond = dateTimeEnd.Value.Second;
        ...
        private void btnDownloadTime_Click(object sender, EventArgs e)
        {
            ...
            struDownPara.struStartTime.dwYear = dateTimeStart.Value.Year;
            struDownPara.struStartTime.dwMonth = dateTimeStart.Value.Month;
            struDownPara.struStartTime.dwDay = dateTimeStart.Value.Day;
            struDownPara.struStartTime.dwHour = dateTimeStart.Value.Hour;
            struDownPara.struStartTime.dwMinute = dateTimeStart.Value.Minute;
            struDownPara.struStartTime.dwSecond = dateTimeStart.Value.Second;

            //设置下载的结束时间 Set the stopping time
            struDownPara.struStopTime.dwYear = dateTimeEnd.Value.Year;
            struDownPara.struStopTime.dwMonth = dateTimeEnd.Value.Month;
            struDownPara.struStopTime.dwDay = dateTimeEnd.Value.Day;
            struDownPara.struStopTime.dwHour = dateTimeEnd.Value.Hour;
            struDownPara.struStopTime.dwMinute = dateTimeEnd.Value.Minute;
            struDownPara.struStopTime.dwSecond = dateTimeEnd.Value.Second;
